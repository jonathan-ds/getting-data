#This is the code book for the getting-data course project in markdown format ( as mentioned here: [https://class.coursera.org/getdata-015/forum/thread?thread_id=26] ). As mentioned in the project instructions each variable is defined and explained.  As Further information on each variable can be found in the features_info.txt file.
